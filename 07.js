...
var input = ['123 -> x', '456 -> y', 'x AND y -> d', 'x OR y -> e', 'x LSHIFT 2 -> f', 'y RSHIFT 2 -> g', 'NOT x -> h', 'NOT y -> i', 'x -> z', 'z -> w']
...
function tokenizer (token_array) {
  while (token_array.length) {
    ...
    switch (tokens.length) {
      case 3: symbol_table[rvalue] = function(){return tokens[1](tokens[0], tokens[2])}
        break
      case 2: symbol_table[rvalue] = function(){return tokens[0](tokens[1])}
        break
      case 1: symbol_table[rvalue] = function(){return tokens[0]()}
        break
